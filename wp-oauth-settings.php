	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<p>
				...
				<ol>
					<li>Register as a QuezX Developer at <a href='https://developers.quezx.com/' target="_blank">developers.quezx.com</a>.</li>
					<li>At QuezX, create a new App. This will enable your site to access the QuezX API.</li>
					<li>At QuezX, provide your site's homepage URL (<?php echo $blog_url; ?>) for the new App's Redirect URI. Don't forget the trailing slash!</li>
					<li>Paste your API Key/Secret provided by QuezX into the fields above, then click the Save all settings button.</li>
				</ol>
			</p>
			<?php submit_button('Save all settings'); ?>
			</div> <!-- .form-padding -->
			</div> <!-- .wpoa-settings-section -->
			<!-- END Login with QuezX section -->
